// aama aapde beu joise ke first and last aapdo target number kya spot thay che
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    vector<int> array = {1, 2, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 10};
    int target = 9;
    cout << "first the number was spotted at " << first_occ(array, target) << endl;
    return 0;
}